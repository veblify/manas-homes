    ...
    >
      ...
      <div className="relative z-10 text-center px-4 animate-fade-in-up">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-teko font-bold uppercase tracking-wider mb-4">
          Find Your <span className="text-orange-500">Dream Property</span> With
          Us
        </h1>
        <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-gray-200">
          Your trusted partner in buying, selling, and renting properties across
...
const parsePrice = (price: string): number => {
  if (price.includes("/month")) return -1;

  const numericString = price.replace(/[^0-9.]/g, "");
  const value = parseFloat(numericString);

  if (price.toLowerCase().includes("cr")) return value * 1_00_00_000;
  if (price.toLowerCase().includes("lacs")) return value * 1_00_000;
  ...
  <section id="properties" className="py-20 bg-gray-100">
    <div className="container mx-auto px-6">
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-teko font-bold text-gray-800 uppercase">
          Featured Properties
        </h2>
        <p className="text-lg text-gray-600 mt-2 max-w-2xl mx-auto">
          Discover our handpicked selection of the finest properties available.
        </p>
  ...
  <section id="services" className="py-20 bg-white">
    <div className="container mx-auto px-6">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-gray-600 mt-2 max-w-2xl mx-auto">
          All solutions at one point - from finding a home to financing it.
        </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {services.map((service) => (
          <div
            key={service.title}
            className="text-center p-8 border rounded-lg hover:shadow-xl transition-shadow duration-300 bg-gray-50"
          >
...
const WhyChooseUs: React.FC<{ features: Feature[] }> = ({ features }) => (
  <section id="about" className="py-20 bg-gray-100">
    <div className="container mx-auto px-6">
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-teko font-bold text-gray-800 uppercase">
          Why Choose Manas Homes?
        </h2>
        <p className="text-lg text-gray-600 mt-2 max-w-2xl mx-auto">
          Experience the difference with a partner who values integrity and your
          dreams.
        </p>
        <div className="mt-4 w-24 h-1 bg-orange-500 mx-auto"></div>
      </div>
...
const Testimonials: React.FC<{ testimonials: Testimonial[] }> = ({
  ...
  <section id="testimonials" className="py-20 bg-blue-700 text-white">
    <div className="container mx-auto px-6">
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-teko font-bold uppercase">
          What Our Clients Say
        </h2>
        <p className="text-lg text-blue-200 mt-2 max-w-2xl mx-auto">
          We are proud to have earned the trust of families and businesses.
        </p>
        <div className="mt-4 w-24 h-1 bg-orange-500 mx-auto"></div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {testimonials.map((testimonial) => (
          <div
            ...
            className="bg-blue-600 p-8 rounded-lg shadow-lg"
          >
  ...
  <footer id="contact" className="py-20 bg-gray-800 text-gray-300">
    <div className="container mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
        <div>
          <h3 className="text-2xl font-teko font-semibold text-white mb-4">
            Manas Homes
          </h3>
          <p className="text-gray-400">
            Your trusted partner in realizing real estate dreams. All solutions
            at one point.
          </p>
        ...
        <div>
          ...
          <address className="not-italic">
            ...
            <div className="flex items-center justify-center md:justify-start mb-2 space-x-2 hover:text-orange-400 transition-colors">
              ...
              <a href="tel:+919594626392">+91 9594626392</a>
            </div>
            <div className="flex items-center justify-center md:justify-start mb-2 space-x-2 hover:text-orange-400 transition-colors">
              <PhoneIcon className="w-5 h-5" />{" "}
              <a href="tel:+919067172056">+91 9067172056</a>
            </div>
            <p className="mt-2">Badlapur 421503</p>
          </address>
        </div>
      </div>
      <div className="mt-12 mb-[-3rem] border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p className="text-sm text-gray-500">
          &copy; {new Date().getFullYear()} Manas Homes. All Rights Reserved.
        </p>
        <p className="text-sm text-gray-500">
          &copy; {new Date().getFullYear()} Manas Homes:Developed & maintained
          by:
          <a href="https://veblify.vercel.app/" target="_blank">
            VEBLIFY
          </a>
        </p>
        <div className="flex space-x-4 mt-4 md:mt-0">
          <a
            href="https://www.instagram.com/manas.homes/"
            target="_blank"
          ...
          <a
            href="https://facebook.com/Manas.Homes5"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-orange-400 transition-colors"
            aria-label="Facebook"
          ...
          <a
            href="https://www.youtube.com/@manas.homes5"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-400 hover:text-orange-400 transition-colors"
            aria-label="YouTube"
...
const App: React.FC = () => {
  ...
  // ⭐ Uploaded properties from Firebase
  ...
  // ⭐ Fetch uploaded properties from Firebase
  useEffect(() => {
  ...
  // ⭐ Apply filters to BOTH demo + uploaded properties
  useEffect(() => {
    let result = [...PROPERTIES, ...uploadedProperties];
  ...
  }, [locationFilter, propertyType, priceRange, uploadedProperties]);
