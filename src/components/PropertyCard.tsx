  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 group">
      <div className="relative">
        <img src={property.imageUrl} alt={property.title} className="w-full h-56 object-cover transition-transform duration-300 group-hover:scale-110" />
        <div className="absolute top-4 left-4 bg-orange-500 text-white text-xs font-bold px-3 py-1 rounded-full">{property.status}</div>
      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <p className="text-sm text-gray-600 bg-blue-100 px-3 py-1 rounded-full">{property.type}</p>
        </div>
        <div className="flex justify-around text-gray-700 border-t border-b py-3">
          ...
          <div className="text-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mx-auto mb-1 text-orange-500">
